...
public class User implements Serializable {
	...
	public void setActivated(Boolean activa) {
		this.activated = activa;
	}
	@Override
	public int hashCode() {
	...
	public String toString() {
		return "User [name=" + name + ", lastname=" + lastname + ", address=" + address + ", email="
				+ email + ", username=" + username + ", password=" + password + ", activated=" + activated + "]";
	}
